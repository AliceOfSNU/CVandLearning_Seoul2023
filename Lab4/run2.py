...
config = {
    "beam_width" : 3,
    "lr"         : 5e-4,
    "lr_schedule": "ReduceLROnPlateau with 5 patience, only after tf has been fully reduced",
    "epochs"     : 100,
    "batch_size": 96,
    "weight_decay" : 1e-3,
    ...
    "n_decodes": 10,
    "mlp_layers": 2,
    "tf_schedule": "Reduce by 0.1 every 15 epochs in small steps",
    "encoder_hidden_size": 64,
    "attn_hidden_size": 128,
    "decoder_hidden_size": 128,
    "data_features": 28,
    "init_method": "uniform -0.1~0.1",
    "run_id": "attn_64_categorical_draw_0.3dropout",
    "notes": "dropout everywhere, uses gumbel softmax categorical",
